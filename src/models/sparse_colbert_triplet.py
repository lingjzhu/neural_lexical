...
class SparseColBERTTripletEvaluator(TripletEvaluator):
    ...
    def __call__(
        ...
        with (
            ...
            anchors_val, anchors_ind = model.encode(
                sentences=self.anchors,
                batch_size=self.batch_size,
                show_progress_bar=self.show_progress_bar,
                return_tensors=True,
            )
            positives_val, positives_ind = model.encode(
                sentences=self.positives,
                batch_size=self.batch_size,
                show_progress_bar=self.show_progress_bar,
                return_tensors=True,
            )
            negatives_val, negatives_ind = model.encode(
